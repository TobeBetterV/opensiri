...
This file is an OpenSiri repo-local overlay for the `fireworks-tech-graph` skill. Read the skill first, then apply these rules when generating or editing SVG technical diagrams for this repository. If this file conflicts with the upstream skill, use the stricter rule.
