...
# Legacy monolithic release entry point. Prefer release-opensiri.sh; this file
# is temporarily retained as a fallback during workflow migration.

set -euo pipefail

APP_NAME="OpenSiri"
SCHEME_NAME="OpenSiri"
TARGET_NAME="OpenSiri"
CONFIGURATION="Release"

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
WORKSPACE_PATH="$ROOT_DIR/OpenSiri.xcworkspace"
PROJECT_PATH="$ROOT_DIR/OpenSiri.xcodeproj/project.pbxproj"
...
RELEASE_NOTES_BASE_URL="https://github.com/TobeBetterV/opensiri/releases/tag"
RELEASE_DOWNLOAD_BASE_URL="https://github.com/TobeBetterV/opensiri/releases/download"
...
NOTARYTOOL_PROFILE="${NOTARYTOOL_PROFILE:-opensiri-release}"
...
main() {
    ...
    xcodebuild build \
        ...
        "OPENSIRI_RELEASE_PACKAGING=YES" | xcbeautify
