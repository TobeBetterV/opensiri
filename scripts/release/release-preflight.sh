...
validate_environment() {
    ...
    require_release_dir "$RELEASE_SOURCE_ROOT/OpenSiri.xcodeproj"
    require_release_dir "$RELEASE_SOURCE_ROOT/OpenSiri.xcworkspace"
...
validate_release() {
    ...
    current_version="$(asc xcode version view \
        --project "$RELEASE_WORKTREE/OpenSiri.xcodeproj" \
