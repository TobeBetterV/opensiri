...
struct AppleLanguageDetectorTests {
    ...
    func testChineseEnglishMixedTextDetection() {
        ...
        #expect(detector.detectLanguage(text: "欢迎使用 OpenSiri翻译软件!") == .simplifiedChinese)
        #expect(
        ...
        #expect(
            detector.detectLanguage(text: "访问网站: https://opensiri.app 了解更多信息.")
                == .simplifiedChinese
        )
    ...
    func testMixedTextDetailedAnalysis() {
        ...
        let mixedText = "欢迎使用 OpenSiri翻译软件! 这是一个强大的翻译工具, 支持多种服务, 包括Google翻译、DeepL翻译等."
