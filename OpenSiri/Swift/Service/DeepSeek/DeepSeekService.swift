...
/// compatible fields OpenSiri already uses and adds DeepSeek V4's `thinking`
...
/// endpoint, built from OpenSiri's provider-agnostic prompt messages.
...
/// content delta is needed for OpenSiri's text output pipeline.
