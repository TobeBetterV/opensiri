...
class OCRTextNormalizer {
    ...
    /// - `"Visit https://opensiri.app, it's great!"` → URL excludes the comma
    /// - `"Email me at test@example.com."` → Email excludes the period
    /// - `"Version 1.2.3, released today."` → Version excludes the comma
    ///
    /// **Example Input:**
    /// ```
    /// "访问 https://opensiri.app, 邮箱 test@example.com. 版本 1.2.3, 价格 $10.99, 代码 array.map()."
    /// ```
    ///
    /// **Example Output:**
    /// ```
    ...
    /// protectionMap: [
    ///   "〈PROTECTED_0〉": "https://opensiri.app",
    ...
    /// ]
    ///
    /// Output: "访问 https://opensiri.app，邮箱 test@example.com。价格 $10.99，代码 array.map()。"
    /// ```
    ///
