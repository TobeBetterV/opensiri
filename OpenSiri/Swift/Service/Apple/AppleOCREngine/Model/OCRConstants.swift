...
enum OCRConstants {
    ...
    /// Root directory for logs: ~/Library/Caches/com.opensiri.OpenSiri/MMLogs
    ...
    /// Directory for images: ~/Library/Caches/com.opensiri.OpenSiri/MMLogs/Image
    ...
    /// File for snip image: ~/Library/Caches/com.opensiri.OpenSiri/MMLogs/Image/snip_image.png
    static var snipImageFileURL: URL {
        imageDirectoryURL.appendingPathComponent("snip_image.png")
    }

    /// File for crop image: ~/Library/Caches/com.opensiri.OpenSiri/MMLogs/Image/ocr_cropped_image.png
