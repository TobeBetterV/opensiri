...
- (void)openURLScheme:(NSString *)URLScheme completion:(void (^)(BOOL isSuccess, NSString *_Nullable returnValue, NSString *_Nullable actionKey))completion {
    ...
    if (![self isOpenSiriScheme:text]) {
        completion(NO, @"Invalid OpenSiri Scheme", nil);
        return;
    }
    ...
    if (![allowedActions containsObject:action]) {
        if ([action isEqualToString:EZQueryKey]) {
            ...
            completion(NO, @"Invalid OpenSiri Action", nil);
        }
...
/// Write key value to NSUserDefaults. opensiri://writeKeyValue?EZOpenAIAPIKey=sk-zob
...
/// Read value of key from NSUserDefaults. opensiri://readValueOfKey?EZOpenAIAPIKey
...
- (BOOL)enabledReadWriteKey:(NSString *)key {
    ...
    // opensiri://writeKeyValue?Google-IntelligentQueryTextType=0
...
- (void)resetUserDefaultsData {
    // opensiri://resetUserDefaultsData
...
- (void)saveUserDefaultsDataToDownloadFolder {
    // opensiri://saveUserDefaultsDataToDownloadFolder
...
- (NSArray *)allowedReadWriteKeys {
    /**
     opensiri://writeKeyValue?EZBetaFeatureKey=1
     
     opensiri://writeKeyValue?EZOpenAIAPIKey=sk-zob
     opensiri://writeKeyValue?EZOpenAIServiceUsageStatusKey=1
     opensiri://writeKeyValue?EZOpenAIModelKey=gpt-3.5-turbo
     opensiri://writeKeyValue?EZOpenAIEndPointKey=https://api.ohmygpt.com/azure/v1/chat/completions
     opensiri://writeKeyValue?EZOpenAIDictionaryKey=0
     opensiri://writeKeyValue?EZOpenAISentenceKey=0
     
     opensiri://writeKeyValue?EZDeepLAuthKey=xxx
     opensiri://writeKeyValue?EZDeepLTranslationAPIKey=1
     
     // Youdao TTS
     opensiri://writeKeyValue?EZDefaultTTSServiceKey=Youdao
     
     // Intelligent Query Mode, enable mini window
     opensiri://writeKeyValue?IntelligentQueryMode-window1=1
     
     // Intelligent Query
     opensiri://writeKeyValue?Google-IntelligentQueryTextType=5  // translation | sentence
     opensiri://writeKeyValue?Youdao-IntelligentQueryTextType=2  // dictionary
     */
