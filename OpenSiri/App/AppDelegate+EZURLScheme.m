...
- (void)registerRouters {
    ...
    [routes addRoute:@"/:action" handler:^BOOL(NSDictionary *parameters) {
        ...
        /**
         Recommend use opensiri://query?text=xxx, opensiri://xxx is a bit ambiguous and complex.

         opensiri://good
         opensiri://query?text=good
         opensiri://good%2Fgirl  (opensiri://good/girl)
         */
...
/// Get query text from URL scheme, opensiri://good%2Fgirl --> good%2Fgirl
...
- (void)handleURLEvent:(NSAppleEventDescriptor *)event withReplyEvent:(NSAppleEventDescriptor *)replyEvent {
    ...
    /**
     ...
     opensiri://query?text=Agent Mode & Auto Context

     */
    NSURL *URL = [NSURL URLWithString:[urlString ns_encodeIncludingAmpersandSafely]];

    // opensiri://query?text=good, opensiri://query?text=你好
