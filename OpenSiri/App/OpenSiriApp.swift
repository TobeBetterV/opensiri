...
// MARK: - OpenSiriCmpatibilityEntry

@main
enum OpenSiriCmpatibilityEntry {
    static func main() {
        parseArmguments()
        ...
        // on text input. OpenSiri needs no system AutoFill suggestions, so
