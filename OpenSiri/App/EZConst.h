...
static NSString *const EZBundleId = @"com.opensiri.OpenSiri";
static NSString *const EZDebugBundleId = @"com.opensiri.OpenSiri-debug";

/// TobeBetterV/opensiri
static NSString *const EZGithubRepoOpenSiri = @"TobeBetterV/opensiri";
static NSString *const EZGithubRepoOpenSiriURL = @"https://github.com/TobeBetterV/opensiri";
